...
// #else
//   if (caller->mm->pgd) ret_pte = caller->mm->pgd[pgn];
//   return ret_pte;
// #endif
// }
...
//      // --- LEVEL 5: PT ---
//      // PT đã tồn tại (do PMD trỏ tới), đây là nơi chứa PTE cuối cùng.
//      // Ở bước memset này chưa gán FPN, chỉ đảm bảo cấu trúc tồn tại.

//      // Tăng địa chỉ lên trang tiếp theo (4KB)
...
//   ret_rg->rg_end = addr + pgnum * PAGING64_PAGESZ; // Dùng PAGING64_PAGESZ
...
//         // Thêm vào đầu danh sách (stack-like) cho đơn giản
//         newfp_str->fp_next = *frm_lst;
//         *frm_lst = newfp_str;
//     } 
//     else {
//         // Hết RAM -> Trả về mã lỗi để xử lý swap
//         return -3000;
//     }
//   }
